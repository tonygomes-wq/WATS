...
-- Execute cada bloco separadamente se houver erros

-- =============================================
-- TABELA: bot_flows (fluxos principais)
-- =============================================
...
-- =============================================
-- TABELA: bot_flow_versions (versões publicadas)
-- =============================================
...
-- =============================================
-- TABELA: bot_edges (conexões entre nós)
-- =============================================
...
-- =============================================
-- TABELA: bot_sessions (sessões ativas do bot)
-- =============================================
...
-- =============================================
-- TABELA: bot_logs (logs de execução)
-- =============================================
...
-- =============================================
-- TABELA: chat_webhook_logs (logs de webhook)
-- =============================================
...
-- =============================================
-- ADICIONAR COLUNA bot_session_id (se não existir)
-- Execute separadamente - ignore erro se já existir
-- =============================================
-- ALTER TABLE chat_conversations ADD COLUMN bot_session_id BIGINT UNSIGNED NULL;
